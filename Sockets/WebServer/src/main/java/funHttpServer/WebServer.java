      ...
      if (request == null) {
        ...
        if (request.length() == 0) {
          ...
          // extract required fields from parameters
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("The query is missing something");
          }
         ...
         // System.out.println(json);
          ...
          query_pairs = splitQuery(request.replace("guess?",""));
            ...
            if(num > max || num < 1){
              ...
              builder.append("Content-Type: text/html; charset=utf-8\n");
              builder.append("\n");
              builder.append("'num' must be in the range between 1 and " + max);
              throw new Exception("'num' must be in the range between 1 and " + max);
            }
